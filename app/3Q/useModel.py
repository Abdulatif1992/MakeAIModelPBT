...
fayl_name = script_path / "data" / "3Q_DB _United_C.xlsx"
# Load the model and the scaler from the file
model = joblib.load(script_path / "model" / "3Q_2412.pkl")
scaler = joblib.load(script_path / "model" / "3Q_2412_scaler.pkl")
...
updated_fayl_nomi = script_path / "result" / "3Q_United_C(result).xlsx"
